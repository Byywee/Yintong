...
elseif ($_REQUEST['act'] == 'query')
{
	...
	$smarty->assign('page_count',   $stock_in['page_count']);
	make_json_result($smarty->fetch('stock_in.htm'), '',
	array('filter' => $stock_in['filter'], 'page_count' => $stock_in['page_count']));
}
