...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    /* 模板赋值 */
	switch($goods['sale_return_able_date']){
	case 7*24*3600:$goods['sale_return_able_date']='oneweek';break;
	case 30*24*3600:$goods['sale_return_able_date']='onemonth';break;
	case 30*3*24*3600:$goods['sale_return_able_date']='threemonths';break;
	case 30*6*24*3600:$goods['sale_return_able_date']='sixmonths';break;
	case 12*30*24*3600:$goods['sale_return_able_date']='oneyear';break;
...
elseif($_REQUEST['act'] == 'stock')
{
	...
	//退货
	$get_return_stock = get_return_stock();
	$smarty->assign('get_return_stock',$get_return_stock);
	//盘点
	$goods_stock_count = get_stock_count();
	$smarty->assign('goods_stock_count',$goods_stock_count);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $sale_return_able_date = !empty($_POST['sale_return_able_date']) ? $_POST['sale_return_able_date'] : 0;
    ...
    if ($is_insert)
    {
	switch($sale_return_able_date){
	case 'oneweek':$sale_return_able_date=7*24*3600;break;
	case 'onemonth':$sale_return_able_date=30*24*3600;break;
	case 'threemonths':$sale_return_able_date=30*3*24*3600;break;
	case 'sixmonths':$sale_return_able_date=30*6*24*3600;break;
	case 'oneyear':$sale_return_able_date=12*30*24*3600;break;
        ...
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, shop_price,sale_return_able_date, market_price, is_promote, promote_price, " .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$sale_return_able_date','$market_price', '$is_promote','$promote_price', ".
	...
	switch($sale_return_able_date){
	case 'oneweek':$sale_return_able_date=7*24*3600;break;
	case 'onemone':$sale_return_able_date=30*24*3600;break;
	case 'threemones':$sale_return_able_date=30*3*24*3600;break;
	case 'sixmones':$sale_return_able_date=30*6*24*3600;break;
	case 'oneyear':$sale_return_able_date=12*30*24*3600;break;
...
{
	$sql_get_goods_stock_num  = " select goods_id,goods_name,goods_sn,goods_number from ".$GLOBALS['ecs']->table('goods');
	$goods_stock_num = $GLOBALS['db']->getAll($sql_get_goods_stock_num);
	return $goods_stock_num;
}
