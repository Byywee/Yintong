...
$_LANG['batch_stock_in_ok'] = '批量进货成功。';
...
//库存管理
$_LANG['lable_info_stock_num'] = '账面库存';
$_LANG['lable_fact_stock_num'] = '实际库存';
$_LANG['lable_loss_stock_num'] = '损耗数量';
$_LANG['lable_loss_stock_note'] = '损耗备注';
$_LANG['lab_stock'] = '进货';
$_LANG['lab_return_goods'] = '退货';
...
$_LANG['notice_give_integral'] = '购买该商品时赠送消费积分数,-1表示按商品价格赠送,你还可以按照百分比赠送积分';
$_LANG['notice_rank_integral'] = '购买该商品时赠送等级积分数,-1表示按商品价格赠送,你还可以按照百分比赠送积分';
