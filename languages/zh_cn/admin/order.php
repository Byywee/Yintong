...
$_LANG['goods_number'] = '订货数量';
$_LANG['goods_return_number'] = '退货数量';
$_LANG['goods_attr'] = '属性';
$_LANG['goods_delivery'] = '已发货数量';
$_LANG['goods_delivery_curr'] = '此单发货数量';
$_LANG['storage'] = '库存';
$_LANG['sale_return_status'] = '退货处理';
$_LANG['subtotal'] = '小计';
$_LANG['label_total'] = '合计：';
$_LANG['label_total_weight'] = '商品总重量：';
$_LANG['is_shipments'] = '是否发货';
$_LANG['is_shipments_yes'] = '是';
$_LANG['is_shipments_no'] = '否';
$_LANG['sale_return_status_yes'] = '已处理';
$_LANG['sale_return_status_no'] = '未处理';
$_LANG['sale_return_status_no_back'] = '无退货';
$_LANG['change_inventory'] = '加入到库存';
