...
/*库存管理*/
$_LANG['01_stock_sel'] = '库存查看';
$_LANG['02_stock_add'] = '库存添加';
$_LANG['cur_stock_number'] = '当前库存';
$_LANG['in_stock_number'] = '入库总量';
$_LANG['out_stock_number'] = '出库总量';

//库存管理
$_LANG['031_goods_stock'] = '库存管理';

$_LANG['01_goods_stock_in'] = '进货列表';
